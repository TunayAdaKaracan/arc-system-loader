--[[pod_format="raw",created="2024-06-26 12:33:32",modified="2024-09-28 21:05:20",revision=1159]]
...
local function install_arcsystem()
	...
	mkdir("/systems")
	-- Always install picotron system freshly. In case there is a update issue
	rm("/systems/picotron")	
